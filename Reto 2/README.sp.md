...
2. [App](./App) Carpeta con los scripts de Python Modelo-Vista-Controlador (MVC). Aquí los estudiantes implementan su código para completar el reto.
3. [Data](./Data) Carpeta con archivos de datos CSV para cargar en la aplicación. Aquí los estudiantes agregan los archivos de datos proporcionados por el personal del curso para completar el reto.
4. [Docs](./Docs) Carpeta con los informes, tabla de datos y otra documentación. Aquí los estudiantes agregan su informe de proyecto, tablas de datos y otra documentación para complementar su implementación de código.
